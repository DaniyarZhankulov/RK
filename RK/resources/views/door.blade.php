    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3SupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Выбор Двери</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container py-5">
      <div class="row gradient-overlay">
        <div class="col-md-12 text-white" style="">
          <h1 class="display-3 mb-4">Выбор двери</h1>
          <div class="row">
            <div class="col-md-9 p-4">
              <img class="img-fluid d-block" width=1000px src="http://localhost/Gdoors/resources/images/interiors/interior-1.jpg"> </div>
            <div class="col-md-3 p-4">
              <h1 class="">Дверь 1</h1>
              <p class="">Описание&nbsp;Описание&nbsp;&nbsp;Описание&nbsp;<br>Описание&nbsp;Описание&nbsp;Описание&nbsp;<br>Описание</p>
              <p class="text-left">Материал:</p>
              <p class="text-left">Высота:</p>
              <p class="text-left">Ширина:</p>
              <p class="text-left">Цена:</p>
              <a href="#" class="btn btn-lg mx-1 btn-primary">В корзину</a>
            </div>
          </div>
          <div class="row">
              ...
              <div class="row">
                @foreach ($doors as $door)
                  <div class="col-md-2 p-4">
                    <img class="img-fluid d-block" style = "max-height:130px;" src= {{ $door->image_link1 }} >
                    <h4 class="my-3">{{ $door->name }}</h4>
                  </div>
                @endforeach
              </div>
              <div class="btn-group">
          ...
          <div class="col-md-12 my-3">
            ...
            <a href="http://localhost/GDoors/public/bucket" class="btn btn-lg btn-primary mx-1">Далее</a>
          </div>
        </div>
      </div>
    </div>
