<html><head>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3SupportedContent">
        ...
        <a class="ml-3 btn navbar-btn btn-primary" href="#" style="">Корзина</a>
      </div>
    </div>
  </nav><div class="py-5 text-center opaque-overlay" style="background-image: url(http://localhost/Gdoors/resources/images/backgrounds/bg-1.jpg);">
    <div class="container py-5">
      <div class="row gradient-overlay">
        <div class="col-md-12 text-white" style="">
          <h1 class="display-3 mb-4">Корзина</h1>
          <h2 class="mb-4">Ваша корзина содержит</h2>
          <div class="row">
            <div class="col-md-6 p-4">
              <div class="row">
                ...
                <div class="p-4 col-md-6">
                  <h3 class="text-left">Дверь 1</h3>
                  <h4 class="text-left">Цена:</h4>
                  <h4 class="text-left">Материал:</h4>
                  <h4 class="text-left">Размер:</h4>
                </div>
                <div class="col-md-2 px-0 py-5" style=""> <a href="#" class="btn btn-outline-light"><i class="d-block fa fa-3x fa-window-close-o"></i></a> </div>
              </div>
            </div>
            <div class="col-md-6 p-4">
              <div class="row">
          ...
          <div class="col-md-12 my-3">
            ...
            <a href="http://localhost/GDoors/public/purchase" class="btn btn-lg btn-primary mx-1">Купить</a>
          </div>
        </div>
      </div>
    </div>
