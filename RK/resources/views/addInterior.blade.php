      ...
      <div class="row gradient-overlay">
        <div class="col-md-12 text-white" style="">
                ...
                <div class="form-group">
                  <fieldset class="form-group">
                    <div class="input-group">
                      <input type="file" class="form-control" placeholder="" aria-describedby="basic-addon1" name="userInterior"> 
                    </div>
                  </fieldset>
          ...
          <div class="col-md-12 my-3">
            <a href="http://localhost/GDoors/public/interior" class="btn btn-lg mx-1 btn-secondary">Назад</a>
          </div>
        </div>
      </div>
    </div>
