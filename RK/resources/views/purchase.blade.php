<html><head>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3SupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/GDoors/public/interior">Выбор Интерьера</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/GDoors/public/door">Выбор Двери</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Покупка</a>
          </li>
        </ul>
  ...
  <div class="py-5 text-center opaque-overlay bg-color" style="background-image: url(http://localhost/Gdoors/resources/images/backgrounds/bg-1.jpg);">
    <div class="container py-5">
      <div class="row gradient-overlay">
        <div class="col-md-12 text-white" style="">
          <h1 class="display-3 mb-4">Покупка</h1>
          <div class="row">
            <div class="col-md-6">
              <img class="img-fluid d-block" src="https://pingendo.com/assets/photos/wireframe/photo-1.jpg"> </div>
            <div class="col-md-6">
              <p>Оставьте контактные данные, наш сотрудник свяжется с вами в близжайшее время.</p>

              <form method="POST" action="purchase/create" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group"> 
                  ...
                  <input type="number" class="form-control" id="InputPhone" name="phone" placeholder="Ваш номер телефона"> 
                </div>
                <div class="form-group"> 
                  <label for="Textarea">Комментарий (необязательное поле)</label>
                  <textarea class="form-control" id="Textarea" name="comment" rows="3" placeholder="Ваш комментарий"></textarea> 
                </div>
          ...
          <div class="col-md-12 my-3">
            ...
            <a href="http://localhost/GDoors/public/finish" class="btn btn-lg btn-primary mx-1" style="">Далее</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="p-4 col-md-4">
          ...
          <p class="text-white">Мы занимаемся поиском&nbsp;
            <br>дверей Вашей мечты</p>
        </div>
